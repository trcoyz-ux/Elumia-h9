...
from ..utils import generate_appointment_auto_id
...
def book_appointment():
    ...
    new_appointment.appointment_auto_id = generate_appointment_auto_id(Appointment)
    ...
    try:
        ...
        return jsonify({
            ...
            "appointment_auto_id": new_appointment.appointment_auto_id,
